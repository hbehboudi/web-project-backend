# Generated by Django 2.1.5 on 2019-02-01 06:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='game',
            name='team_state1',
            field=models.CharField(blank=True, choices=[('W', 'برنده'), ('D', 'تساوی'), ('L', 'بازنده')], max_length=1, null=True, verbose_name='نتیجه بازی ۱'),
        ),
        migrations.AlterField(
            model_name='game',
            name='team_state2',
            field=models.CharField(blank=True, choices=[('W', 'برنده'), ('D', 'تساوی'), ('L', 'بازنده')], max_length=1, null=True, verbose_name='نتیجه بازی ۲'),
        ),
        migrations.AlterField(
            model_name='game',
            name='yellow_cards1',
